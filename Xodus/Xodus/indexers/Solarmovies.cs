...
namespace Xodus
{
    public class Solarmovies : IIndexer
    {
        public async Task<List<IResolver>> GetMovieLink(string movie, int year)
        {
            ...
            try
            {
                ...
                var url = $"https://solarmoviez.to/movie/search/{quotetitle}.html";
                ...
                if (!string.IsNullOrEmpty(dataUrl))
                {
                    ...
                    url = $"https://solarmoviez.to/ajax/v4_movie_episodes/{servernum}";
                    ...
                    {
                        var test = $"https://solarmoviez.to/ajax/movie_token?eid={id}&mid={servernum}";
                        ...
                        test = $"https://solarmoviez.to/ajax/movie_sources/{id}?x={param1}&y={param2}";
